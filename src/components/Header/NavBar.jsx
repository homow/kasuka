    ...
    return (<StrictMode>
        <nav className={"z-50 fixed bg-black/80 backdrop-blur-3xl z-10 top-0 py-4 right-0 left-0"}>
            <div className={'container flex items-center justify-between'}>
                ...
                <ul className={'z-50 max-md:fixed top-0 -right-45 -bottom-[100vh] transition-all duration-150 flex gap-1 max-md:flex-col md:flex-row md:grow md:justify-center md:gap-5 lg:gap-12 font-dana-md max-md:text-black max-md:bg-white w-40'} id={"menu"}>
                    <li>
